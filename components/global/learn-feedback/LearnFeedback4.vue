  ...
  <markdown-container>
    <markdown-column size="1" style="padding-right: 3em">
      <div v-if="sectionIndex == 0">
        ...
        <p>
          Indicates there is a missed opportunity to engage these individuals in
          care.
        </p>
        <p>
          Potential strategies to engage this group could include harm reduction
          initiatives and services at point of care, which in turn would
          challenge stigma from healthcare workers.
        </p>
      </div>
      <div v-else-if="sectionIndex == 1">
        <h3>16% of people overdosed and had no engagement with medical care</h3>
        <p>
          Highlights a need for community-based / non-clinical strategies to
          engage, focussing on reducing barriers to care
        </p>
      </div>
      <div v-else-if="sectionIndex == 2">
        <h3>
      ...
      <div v-else>
        <p>
          Study: BC healthcare utilization patterns by people who experience an
